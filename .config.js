...
module.exports = {
  ...
  //ATRIS
  API_URL: process.env.API_URL || 'https://atris.life/test',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://atris.life/test',
  DATA_URL: process.env.DATA_URL || 'https://atris.life/test',
  BLIP_URL: process.env.BLIP_URL || 'https://atris.life/test',
  ...
  DEFAULT_TIMEZONE: process.env.DEFAULT_TIMEZONE || 'Europe/Amsterdam',
